...
namespace ProjectViews.Controllers
{
    public class NhanVienController : Controller
    {
        ...
        {
            var lstNhanVien = await _services.GetAll<NhanVien>("https://localhost:7255/api/NhanViens/Get-All");
        ...
        public async Task<IActionResult> CreateNhanVien(NhanVienModel nvmodel)
        {
            ...
            var user = await _services.GetAll<NhanVien>("https://localhost:7255/api/NhanViens/Get-All");
            ...
            if (ModelState.IsValid)
            {
                ...
                var respon = await _services.Add("https://localhost:7255/api/NhanViens/", nv);
        ...
        {
            await _services.Remove<NhanVien>("https://localhost:7255/api/NhanViens/GetById/", "https://localhost:7255/api/NhanViens/Delete/", id);
        ...
        public async Task<IActionResult> Edit(string id)
        {
            ...
            var nvid = await _services.GetById<NhanVien>("https://localhost:7255/api/NhanViens/GetById/", idnv);
        ...
        public async Task<IActionResult> Update(UpdateNhanVien nv)
        {
            ...
            var nvs = await _services.GetById<NhanVien>("https://localhost:7255/api/NhanViens/GetById/", nv.Id);

            var email = await _services.GetAll<NhanVien>("https://localhost:7255/api/NhanViens/Get-All");
            email = email.Where(p => p.Email != nvs.Email);

            var sdt = await _services.GetAll<NhanVien>("https://localhost:7255/api/NhanViens/Get-All");
            ...
            await _services.Update<UpdateNhanVien>("https://localhost:7255/api/NhanViens/Update/", update, nv.Id);
            return RedirectToAction("Index", "NhanVien");
        }
        public async Task<IActionResult> Detail(Guid id)
        {
            ...
            var model = await _services.GetById<NhanVien>("https://localhost:7255/api/NhanViens/GetById/", id);
